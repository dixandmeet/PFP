...
export default function PlayerCreditsScreen() {
  ...
  return (
    ...
    >
      {/* Balance Card */}
      <View className="mx-4 mt-4 bg-gradient-to-br from-pitch-600 to-pitch-800 rounded-2xl p-6 bg-pitch-600">
        ...
        <View className="flex-row gap-3 mt-6">
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text className="text-white/80 text-sm font-semibold">Historique</Text>
          </TouchableOpacity>
        </View>
      </View>
