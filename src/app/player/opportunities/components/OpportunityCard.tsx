...
import { Building2, MapPin, Euro, Calendar, CheckCircle, ChevronRight, Lock, Coins } from "lucide-react"
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {hasApplied && (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium ring-1 ring-green-200">
      ...
      <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
        {hasApplied ? (
          <Button
            variant="outline"
            size="sm"
            className="flex-1 rounded-xl border-slate-200 text-slate-600 hover:border-green-300 hover:text-green-700 font-medium text-xs h-9"
