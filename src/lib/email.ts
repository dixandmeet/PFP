        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 32px 40px;">
              <p style="margin: 0 0 16px; color: #52525b; font-size: 16px;">Bonjour ${userName},</p>
              <h2 style="margin: 0 0 16px; color: #18181b; font-size: 18px; font-weight: 600;">${title}</h2>
              <p style="margin: 0 0 24px; color: #52525b; font-size: 15px; line-height: 24px;">${message}</p>
              <table role="presentation" style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td align="center" style="padding: 8px 0;">
                    <a href="${ctaUrl}" style="display: inline-block; padding: 14px 28px; background-color: #16a34a; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; border-radius: 12px;">${ctaLabel}</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 32px 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 15px; line-height: 24px;">
                Merci pour votre confiance. Votre abonnement <strong>${planName}</strong> est bien activé.
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  ...
  clubSubmittedEmail: (clubName: string, userName: string) => ({
    subject: `Votre club "${clubName}" est en cours de vérification - Profoot Profile`,
    html: `
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 15px; line-height: 24px;">
                Votre demande d'enregistrement pour le club <strong>${clubName}</strong> a bien été soumise.
  ...
  clubApprovedEmail: (clubName: string, userName: string, dashboardUrl: string) => ({
    subject: `Félicitations ! Votre club "${clubName}" est activé - Profoot Profile`,
    html: `
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 15px; line-height: 24px;">
                Excellente nouvelle ! Le club <strong>${clubName}</strong> a été vérifié et activé sur Profoot Profile.
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 16px; line-height: 24px;">
                <strong>${inviterName}</strong> vous invite à créer votre compte sur Profoot Profile 
  ...
  clubMemberInvitationEmail: (inviterName: string, recipientEmail: string, role: string, inviteUrl: string) => {
    ...
    return {
      subject: `${inviterName} vous invite a rejoindre son club - Profoot Profile`,
      html: `
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 16px; line-height: 24px;">
                <strong>${inviterName}</strong> vous invite a rejoindre son club sur Profoot Profile
  ...
  clubRejectedEmail: (clubName: string, userName: string, reason: string) => ({
    subject: `Votre demande pour "${clubName}" nécessite des modifications - Profoot Profile`,
    html: `
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 15px; line-height: 24px;">
                Après examen, la demande d'enregistrement pour le club <strong>${clubName}</strong> n'a pas pu être validée.
              </p>
              <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #fef2f2; border-radius: 8px;">
                <tr>
                  <td style="padding: 16px;">
                    ...
                    <p style="margin: 0; color: #991b1b; font-size: 14px; line-height: 22px;">${reason}</p>
                  </td>
                </tr>
              </table>
